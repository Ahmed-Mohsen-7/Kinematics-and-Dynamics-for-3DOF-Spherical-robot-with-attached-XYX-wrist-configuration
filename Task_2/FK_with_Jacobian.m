DH=[45 0 1 20 0 0];
L=[1 1 0 1 0 1];  %The third link should be zero. It is a DH parameter
...
newj=j;
newj(1:3,4:6)=zeros(3);
%This condition checks if there is simgularity on a given configuration
if det(newj(1:3,1:3))*det(newj(4:6,4:6))==0
    fprintf('This is a signularity!')
end
